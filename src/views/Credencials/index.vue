<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div v-else class="flex items-center justify-between w-full py-3 pl-5 mt-2 rounded bg-brand-gray lg:w-1/2">
        ...
        <div class="flex ml-20 mr-5" v-if="!state.hasError">
          ...
          <icon id="generate-apikey" @click="handleGenerateApikey" name="loading" :color="brandColors.graydark"
            size="24" class="ml-3 cursor-pointer" />
        </div>
      </div>
      ...
      <content-loader v-if="store.Global.isLoading || state.isLoading" class="rounded" width="600px" height="50px" />
      <div v-else class="w-full py-3 pl-5 pr-20 mt-2 overflow-x-scroll rounded bg-brand-gray lg:w-2/3">
...
&lt;script
  ...
  src="https://Railton98-feedbacker-widget.netlify.app/init.js"
&gt;&lt;/script&gt;
        </pre>
      </div>
    </div>
